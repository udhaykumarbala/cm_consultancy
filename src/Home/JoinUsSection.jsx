...
const JoinUsSection = () => {
    ...
    const submitForm = (e) => {
        ...
        const googleFormUrl = 'https://docs.google.com/forms/d/e/1FAIpQLScHW4M5BIUDhKhG_Clgy5CjcvK33IJSCE8tivTFPgDWSFSslQ/formResponse';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-12 lg:gap-x-16 xl:gap-x-32">
                    ...
                    <div className="bg-white shadow-xl rounded-2xl">
                        <div className="p-6 sm:p-10">
                            <h3 className="text-2xl font-semibold tracking-tight text-gray-900 sm:text-3xl">Send us a message</h3>
