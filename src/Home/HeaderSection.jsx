                ...
                <div className="relative flex items-center justify-between">
                    ...
                    {isScreenSmall ? (
                        <div className="flex lg:hidden">
                            ...
                            >
                                <svg className={`w-7 h-7 ${isMenuOpen ? 'hidden' : 'block'}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{
                                    position: 'fixed',
                                    top: '26%',
                                    right: '5%',
                                    zIndex: 100,
                                ...
                                <i className={`fas fa-times w-7 h-7 ${isMenuOpen ? 'block' : 'hidden'}`} style={{
                                    position: 'fixed',
                                    top: '26%',
                                    right: '5%',
                                    zIndex: 100,
